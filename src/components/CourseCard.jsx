...
export default function CourseCard({ course, onEnroll, isEnrolled }) {
  ...
  return (
    <div className="bg-white border border-slate-200 rounded-2xl p-6 flex flex-col gap-3 transition-all duration-200 relative overflow-hidden">
      ...
      <div>
        ...
        <div className="text-[17px] font-bold text-slate-800 leading-tight">{course.title}</div>
      </div>
