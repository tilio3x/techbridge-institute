...
function ContactView({ deliveryLocations }) {
  ...
  if (submitted) {
    return (
      <div style={{ maxWidth: 600, margin: "0 auto", padding: "80px 24px", textAlign: "center" }}>
        ...
        <h2 style={{ fontSize: 28, fontWeight: 900, color: "#f1f5f9", marginBottom: 12 }}>Message Sent!</h2>
  ...
  return (
    <div style={{ maxWidth: 1100, margin: "0 auto", padding: "60px 24px" }}>
      <div style={{ textAlign: "center", marginBottom: 48 }}>
        <h1 style={{ fontSize: "clamp(2rem, 5vw, 3rem)", fontWeight: 900, color: "#f1f5f9", marginBottom: 12 }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 40, alignItems: "start" }}>
        ...
        <div style={{ background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.07)", borderRadius: 16, padding: 32 }}>
          <h2 style={{ fontSize: 20, fontWeight: 800, color: "#e2e8f0", marginBottom: 24 }}>Send Us a Message</h2>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
          {/* Contact Info */}
          <div style={{ background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.07)", borderRadius: 16, padding: 32 }}>
            <h2 style={{ fontSize: 20, fontWeight: 800, color: "#e2e8f0", marginBottom: 20 }}>Contact Information</h2>
            <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              <div style={{ display: "flex", gap: 12, alignItems: "center" }}>
                <div style={{ width: 40, height: 40, borderRadius: 10, background: "rgba(14,165,233,0.1)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 18, flexShrink: 0 }}>📧</div>
                <div><div style={{ color: "#94a3b8", fontSize: 12, fontWeight: 600, textTransform: "uppercase", letterSpacing: 1 }}>Email</div><div style={{ color: "#e2e8f0", fontSize: 14 }}>info@techbridge.edu</div></div>
              </div>
              <div style={{ display: "flex", gap: 12, alignItems: "center" }}>
                <div style={{ width: 40, height: 40, borderRadius: 10, background: "rgba(14,165,233,0.1)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 18, flexShrink: 0 }}>📞</div>
                <div><div style={{ color: "#94a3b8", fontSize: 12, fontWeight: 600, textTransform: "uppercase", letterSpacing: 1 }}>Phone</div><div style={{ color: "#e2e8f0", fontSize: 14 }}>+1 (555) 234-5678</div></div>
              </div>
              <div style={{ display: "flex", gap: 12, alignItems: "center" }}>
                <div style={{ width: 40, height: 40, borderRadius: 10, background: "rgba(14,165,233,0.1)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 18, flexShrink: 0 }}>🕐</div>
                <div><div style={{ color: "#94a3b8", fontSize: 12, fontWeight: 600, textTransform: "uppercase", letterSpacing: 1 }}>Hours</div><div style={{ color: "#e2e8f0", fontSize: 14 }}>Mon–Fri 8am–6pm EST</div></div>
              </div>
            </div>
          </div>
          ...
          {locations.length > 0 && (
            <div style={{ background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.07)", borderRadius: 16, padding: 32 }}>
              <h2 style={{ fontSize: 20, fontWeight: 800, color: "#e2e8f0", marginBottom: 20 }}>Our Locations</h2>
              {locations.map(loc => (
                <div key={loc.id} style={{ marginBottom: 20 }}>
                  <div style={{ color: "#e2e8f0", fontWeight: 700, fontSize: 15, marginBottom: 4 }}>{loc.name}</div>
                  ...
                  {/* Google Maps embed — satellite view, no API key needed */}
                  <div style={{ marginTop: 12, borderRadius: 12, overflow: "hidden", border: "1px solid rgba(255,255,255,0.07)" }}>
                    <iframe
                      title={`Map — ${loc.name}`}
                      width="100%"
                      height="220"
    ...
    <div style={{ minHeight: "100vh", background: "#0a0f1e", color: "#f1f5f9", fontFamily: "'Segoe UI', system-ui, sans-serif" }}>
      ...
      <main>
        ...
        {(!isAuthenticated || !profileLoaded || profile || view === "profile") && (<>
          ...
          {view === "contact" && <ContactView deliveryLocations={deliveryLocations} />}
